...
class QwenEditModule(QwenManager):
    ...
    def generate_sequential_views(self, prompt_image: Image.Image, seed: int, view_count: int = 1) -> dict[str, Image.Image]:
        """
        ...
        Args:
            ...
            seed: Random seed for generation
            view_count: Number of additional views to generate (1 for isometric, 2, 3, or 4)
        ...
        try:
            ...
            view_sequences = {
                1: ["isometric_view"],  # Single isometric 3/4 view for best results
            ...
            if view_count not in view_sequences:
                raise ValueError(f"Unsupported view_count: {view_count}. Must be 1, 2, 3, or 4.")
