...
class Settings(BaseSettings):
    ...
    multiview_count: int = Field(default=1, env="MULTIVIEW_COUNT", description="Number of additional views to generate: 1 (isometric), 2, 3, or 4 (plus original = 2, 3, 4, or 5 total)")
